    ...
    axios
      ...
      .then((res) => {
        ...
        window.sessionStorage.setItem(
          "scecheck",
          JSON.stringify(res.data[0].speak_story).substring(
            1,
            JSON.stringify(res.data[0].speak_story).length - 1
          )
        );
        console.log("scecheck 세션값 => " + sessionStorage.getItem("scecheck"));
        document.getElementById("scecheck").defaultValue =
          sessionStorage.getItem("scecheck");
      })
      .catch((e) => {
        console.error(e);
      });
