import "./Ch1_Game_clear.css";
import axios from 'axios';
import { useNavigate } from "react-router-dom";

const Ch1_Game_clear = () => {

  var star1 = sessionStorage.getItem('star1');
  ...
  return (
    <div className="ch1-1-game1clear">
      ...
      <img className="game1-icon-game1clear" id="star" alt="" src={star1} />
