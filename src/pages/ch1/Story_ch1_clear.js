  ...
  return (
    <div className="ch1-clear-one-final">
      ...
      <div className="div-one-final">
        ...
        <p className="p-one-final">이제 2주가 지나면 본격적인 대학생활이 시작된다.</p>
        <p className="p-one-final">어떤 일들이 날 기다리고 있을까!</p>
        <p className="p3-one-final">너무 설레고 긴장된다😆</p>
      </div>
      <div className="rectangle-div1-one-final" />
      <img className="group-icon1-one-final" alt="" src="../Group-icon1-two.png"
      />
      <img className="group-icon2-one-final" alt="" src="../group-353.svg" />
      <img className="group-icon3-one-final" alt="" src="../Group-icon3-two.png" />
    </div>
  );
};
